...
/**
 * 이 클래스는 IF_memverDAO 인터페이스를 구현하는 클래스 입니다.
...
public class MemberDAOImpl implements IF_MemberDAO{
	...
	public List<MemberVO> selectMember(PageVO pageVO) throws Exception {
		...
		//위에서 쿼리로 보내는 클래스 변수값이 누락 되어서 PreparedStatement.setNull(1, 1111) 널에러가 발생되었습니다.
		return listMember;
	}
