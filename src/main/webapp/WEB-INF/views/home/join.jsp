...
<!-- html5가 아닌 JS로 유효성 검사 코어 임포트(아래2개) -->
...
<div id="container">
	...
	<div class="bodytext_area box_inner">
		...
		<form method="POST" name="join_form" action="/join" class="appForm">
			<fieldset>
				<legend>회원가입폼</legend>
		<p class="info_pilsoo pilsoo_item">필수입력(회원가입 후 관리자의 승인을 받아야 로그인 가능합니다.)</p>
		<ul class="app_list">
			<li class="clear">
				<label for="email_lbl" class="tit_lbl pilsoo_item">사용자ID</label>
			...
			<li class="clear">
				...
				<div class="app_content"><input type="text" name="user_name" class="w100p" id="user_tel_lbl" placeholder="사용자이름을 입력해주세요" required/></div>
			</li>
			<li class="clear">
			...
			<li class="clear">
				<label for="point" class="tit_lbl pilsoo_item">포인트</label>
