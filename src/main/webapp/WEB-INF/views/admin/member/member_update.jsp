    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <!-- 첨부파일을 전송하기 위해서는 enctype필수, 없으면 첨부파일 전송안됨.(아래) -->
          <form name="form_write" action="/admin/member/member_update" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <!-- 암호는 기존값이 필요없음. 이유는 값이 있으면 업데이트진행, 없으면 진행X -->
              ...
              <div class="form-group">
                ...
                <input value="${memberVO.user_name}" name="user_name" type="text"  class="form-control" id="user_name" placeholder="이름을 입력해 주세요." required>
              </div>
              <div class="form-group">
