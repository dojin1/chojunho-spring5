package kr.or.test;
/**
 * 이 클래스는 자바앱에서 개발자 예외를 처리하는 방법,실습 하는 클래스 입니다.
 * @author 조준호
 *
 */
public class ExceptionTest {
	...
	public static void main(String[] args) {
		...
		// 위 처럼 동일 패키지안의 클래스끼리는 import없이 사용 가능합니다.(MemberVO)
		...
		for(int cnt=0;cnt<=3;cnt++) {
			 ...
			 * catch(에러발생 기존정의된상황) {(필수)에러발생시 처리할 구현내용} 
			 * finally {(선택사항)에러가 발생하든 아니든 무조건실행.}
			 */
			try {
