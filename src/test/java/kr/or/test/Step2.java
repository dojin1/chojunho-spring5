package kr.or.test;
/**
 * 이 클래스는 메서드기반의 Step1클래스를 객체(오브젝트)기반의 클래스로 변경한 클래스임.
 * @author 조준호
 *
 */
class MemberVO {
	...
	//void한(반환값 없이)입력하는 셋 메서드 입니다. (아래)
	public void setPhoneNum(String phoneNum) {
		this.phoneNum = phoneNum;//프라이빗 변수를 직접 접근 못함.
								 //퍼블릭 메서드로 입력하게 만들어 놓은구조.
	}
...
public class Step2 {
	...
	public static void main(String[] args) {
		...
		//MemberVO 클래스를 배열객체(String[]처럼)로 생성했음(아래)
