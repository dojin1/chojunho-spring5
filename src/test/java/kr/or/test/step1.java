...
public class step1 {  
	public void Step1( ) {// 클래스명과 같은 이름의 메서드를 생성자 매서드 자동으로 만들어집니다.
		//자동으로 만들어 집니다.
		//중요한 이유는 다른 클래스에서 Step1을 객체로 만들때 생성자 메서드가 필요. 
		//Step1 aaa = new Step1();
		//자바앱에서는 객체를 생성자 메서드로 만들때 필수.
		//단, 스프링에선 @Inject으로 객체를 만들어서사용.
	}
	//멤버변수(전역변수)는 Step1클래스에 영향을 모두 주는 변수
	//내부변수(메서드변수)는 main메서드 내부에서만 영향을 주는 변수
	...
	public static void main(String[] args) {
		...
		phoneNum = "000-0000-0000"; // ;= 1문장 끝을 명시.
	...
	private static void printMember(String name, int age, String phoneNum) {
		...
		// println 메서드는 출력 후 줄바꿈 명령. ln= new line
	}
